...
You'll need a New Relic [license key](/docs/apis/intro-apis/new-relic-api-keys/#ingest-license-key). For information on limits and restricted attributes, see [Metric API requirements and limits](https://docs.newrelic.com/docs/metric-api-general-requirements-limits).
